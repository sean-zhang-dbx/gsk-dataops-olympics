...
def score_team(team_name: str) -> dict:
    ...
    # ─── EDA (5 pts) ───
    if _table_exists(catalog, "heart_silver_correct"):
        scores["eda"] = 5
        log("EDA: heart_silver_correct exists and accessible [+5]")
    else:
        log("EDA: heart_silver_correct not found [+0]")
