    ...
    "instructions": {
        "text_instructions": [{
            ...
            "content": [
                ...
                "- For aggregated questions by age group or diagnosis, prefer heart_gold_correct.\n"
                "- For patient-level filtering and counting, use heart_silver_correct.\n"
                "- sex: 0 = female, 1 = male.\n"
        ...
        "example_question_sqls": [
            ...
            },
            {
                ...
                "sql": [
                    ...
                    "FROM heart_gold_correct ORDER BY age_group"
                ],
            },
            {
                "id": uuid.uuid4().hex,
                ...
                "sql": [
                    ...
                    "FROM heart_silver_correct WHERE sex = 0 AND target = 1"
                ],
            },
            {
                "id": uuid.uuid4().hex,
                ...
                "sql": [
                    ...
                    "ROUND(SUM(CASE WHEN target = 1 THEN 1 ELSE 0 END) * 100.0 / COUNT(*), 1) AS disease_rate_pct "
                    "FROM heart_silver_correct GROUP BY 1 ORDER BY disease_rate_pct DESC"
                ],
            },
            {
                "id": uuid.uuid4().hex,
                ...
                "sql": [
                    "SELECT COUNT(*) AS high_risk_patients "
                    "FROM heart_silver_correct WHERE chol > 240 AND trestbps > 140"
                ],
            },
            {
                "id": uuid.uuid4().hex,
                ...
                "sql": [
                    "SELECT ROUND(AVG(thalach), 1) AS avg_max_heart_rate "
                    "FROM heart_silver_correct WHERE target = 0 AND age < 50"
                ],
            },
        ],
    },
