...
# MAGIC |-------|----------|-------------|
# MAGIC | `heart_silver_correct` | `{TEAM_NAME}.default` | ~488 patient clinical records |
# MAGIC | `heart_gold_correct` | `{TEAM_NAME}.default` | ~8 aggregated cohort metrics |
...
for table, catalog in [
    ("heart_silver_correct", CATALOG),
    ("heart_gold_correct", CATALOG),
...
# MAGIC -- This function queries heart_gold_correct and returns formatted text
...
# MAGIC > 3. Add tables:
# MAGIC >    - `{TEAM_NAME}.default.heart_silver_correct`
# MAGIC >    - `{TEAM_NAME}.default.heart_gold_correct`
# MAGIC > 4. Add **General Instructions**:
# MAGIC >    ```
# MAGIC >    You are a clinical data analyst. The heart_silver_correct table has patient-level records
...
# MAGIC >    target (1=heart disease, 0=healthy). heart_gold_correct is aggregated by age_group and diagnosis.
